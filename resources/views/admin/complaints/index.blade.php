...
@section('content')
    <div class="space-y-6" x-data="{
        ...
        <div class="bg-white rounded-xl shadow-md p-4">
            <form action="{{ route('admin.complaints') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                @if(request('status'))
                ...
                <div>
                    ...
                    <select name="month" class="w-full rounded-lg border-gray-200 text-sm focus:ring-red-500 focus:border-red-500">
                ...
                <div>
                    ...
                    <select name="year" class="w-full rounded-lg border-gray-200 text-sm focus:ring-red-500 focus:border-red-500">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="flex-1 bg-red-600 text-white px-4 py-2 rounded-lg font-bold text-sm hover:bg-red-700 transition shadow-lg shadow-red-200">
                        Filter
                    </button>
                    <a href="{{ route('admin.complaints', ['status' => request('status')]) }}" class="bg-gray-100 text-gray-600 px-4 py-2 rounded-lg font-bold text-sm hover:bg-gray-200 transition text-center">
                        Reset
                    </a>
                </div>
            </form>
            ...
            <div class="divide-y divide-gray-100">
                @forelse($complaints as $complaint)
                    ...
                    <div class="group hover:bg-gray-50 transition-all duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            ...
                                            @elseif($complaint->priority === 'medium')
                                                <span class="px-3 py-1 rounded-full text-xs font-bold bg-yellow-50 text-yellow-700">🟡
                                        ...
                                        <div class="text-sm text-gray-600 mb-3 flex flex-wrap items-center gap-y-1">
                                            ...
                                            <span class="mx-2 text-gray-300">|</span>
                                            <span class="text-gray-500">{{ $complaint->created_at->format('d F Y, H:i') }}</span>
                                        </div>
                                        <div class="bg-gray-50/80 p-4 rounded-xl border border-gray-100">
                                            <p class="text-sm text-gray-700 leading-relaxed">{{ Str::limit($complaint->description, 150) }}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {{-- Hover Gradient Bar --}}
                        <div class="h-1 bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    </div>
                @empty
