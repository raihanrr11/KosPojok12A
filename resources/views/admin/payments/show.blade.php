            ...
            <div class="p-6 sm:p-8">
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <dd class="text-xl font-black text-gray-900">Rp {{ number_format($payment->amount, 0, ',', '.') }}
                        </dd>
                    </div>
                    <div class="space-y-1">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button type="button" @click="verifyModal = true"
                        ...
                        <svg class="w-6 h-6 mr-2 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                ...
                <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden"
                    ...
                    <div class="p-6">
                        <form action="{{ route('admin.payments.verify', $payment) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="admin_notes" class="block text-sm font-bold text-gray-700 mb-1.5 ml-1">Alasan
