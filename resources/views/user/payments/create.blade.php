...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <form method="POST" action="{{ route('user.payments.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" id="amount"
                            value="{{ old('amount', Auth::user()->monthly_rent) }}"
            ...
            <div>
                ...
                <div class="mb-4 bg-gray-50 border border-gray-200 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">
                        <span class="font-bold text-gray-800">Catatan:</span> Nomor rekening tujuan transfer dapat Anda lihat di menu 
                        <a href="{{ route('user.dorm-info') }}" class="text-green-600 font-bold hover:underline">Info Kos</a>.
                    </p>
                </div>
