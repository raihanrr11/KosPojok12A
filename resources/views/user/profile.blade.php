...
@section('content')
    <div style="background: var(--color-background-tertiary, #FFF9EB); min-height: 100vh; padding-bottom: 48px;">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            {{-- Hero Profile Header --}}
            <div
                class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 p-8 shadow-xl">
                ...
                <div class="relative z-10 flex flex-col sm:flex-row sm:items-center gap-6">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        @else
                            <div
                                class="h-24 w-24 rounded-2xl bg-white/20 backdrop-blur-sm ring-4 ring-white/30 shadow-lg flex items-center justify-center">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-3">
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white text-xs font-bold backdrop-blur-sm">
            ...
            <div class="flex items-start gap-3 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                ...
                <p class="text-sm text-blue-800 font-medium">
                    <strong class="font-bold">Informasi:</strong> Jika ada data yang perlu diperbarui (nama, nomor kamar,
                    dll),
                    silakan hubungi admin atau pengelola kos secara langsung.
                </p>
            </div>
