...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    {{-- Header with Amount --}}
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 p-8 shadow-xl">
        <div class="relative z-10 sm:flex sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0">
                @if($payment->status === 'verified')
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold bg-white text-green-700 shadow-sm">
                ...
                @elseif($payment->status === 'rejected')
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold bg-white text-red-600 shadow-sm">
                ...
                @else
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold bg-white text-yellow-600 shadow-sm">
    ...
    @if($payment->status === 'pending')
        <div class="flex items-start gap-4 p-5 bg-yellow-50 border border-yellow-200 rounded-2xl shadow-sm">
            <div class="flex-shrink-0 w-11 h-11 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center shadow-md">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-yellow-700 mt-1 font-medium">Bukti pembayaran Anda sedang ditinjau. Proses verifikasi biasanya membutuhkan waktu <strong>1×24 jam</strong>.</p>
            </div>
        </div>

    @elseif($payment->status === 'rejected')
        <div class="flex items-start gap-4 p-5 bg-red-50 border border-red-200 rounded-2xl shadow-sm">
            <div class="flex-shrink-0 w-11 h-11 bg-gradient-to-br from-red-500 to-pink-600 rounded-xl flex items-center justify-center shadow-md">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-red-700 mt-1 font-medium">Bukti pembayaran Anda tidak dapat diverifikasi. Silakan unggah ulang dengan foto yang lebih jelas atau hubungi admin.</p>
    ...
    @else
        <div class="flex items-start gap-4 p-5 bg-green-50 border border-green-200 rounded-2xl shadow-sm">
            <div class="flex-shrink-0 w-11 h-11 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-md">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
