                ...
                <div>
                    ...
                    <div class="mb-4 bg-gray-50 border border-gray-200 rounded-xl p-4 flex items-center gap-3">
                        ...
                        <p class="text-xs text-gray-600 leading-relaxed">
                            <span class="font-bold text-gray-800">Catatan:</span> Nomor rekening tujuan transfer dapat Anda
                            lihat di menu
                            <a href="{{ route('user.dorm-info') }}" class="text-green-600 font-bold hover:underline">Info
                                Kos</a>.
                        </p>
                    </div>
